...
const Partners = () => {
  ...
  const creamText = [
    'Proposer aux personnes durablement privées d’emploi (PPDE) un emploi en contrat à durée indéterminée, à temps choisi, dans le cadre de l’expérimentation nationale « Territoire zéro chômeur de longue durée ».',
    'Produire et vendre tous types de biens et/ou services auprès des particuliers, des professionnels, des associations et des collectivités territoriales.',
    'Initier ou prendre part à toute initiative susceptible de favoriser le développement de l’emploi et corrélativement d’activités économiques sur le territoire.'
  ]
  const creamTitle = 'Sa mission'
  const creamPic = [fistbump]
  const greenTitle = 'Fonctionnement'
  const greenText = [
    'Elle agit en collaboration avec un Comité Local pour l’Emploi dont les membres sont des élus et/ou des acteurs du territoire pour lesquels la lutte contre le chômage de longue durée est une priorité. Il est présidé par Fabien NEBEL, Maire de Bléré'
  ]
    ...
    <div className='centerContainer'>
      <div className='mainContainer width100'>
        ...
        <p className='cream paragraph'>
          ...
          <br />
          Commune de Bléré / Communauté de Communes Bléré-Val de Cher /
          Département d’Indre et Loire / Région Centre – Val de Loire / CRI
          (Château Renault Insertion) / Association LA MAIN TENDUE (Bléré) /
          Pôle Emploi / Chambres consulaires/ Rotary club d’Amboise (IL Y EN
          AURA D’AUTRES)
        </p>
        <BlockPartners partners={partnersList} />
        <div className='green paragraph'>
          <p>
            Si vous aussi, entreprise ou particulier, vous souhaitez apporter
            votre aide à LA BOÎTE D’À CÔTÉ et participer à la réussite de cette
